...
/**
 * SecondaryTransaction Class Doc Comment
 *
 * @category Class
...
class SecondaryTransaction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecondaryTransaction';
     ...
     * Sets requestType
     *
     * @param string $requestType Object name of the secondary transaction request.
     *
     * @return $this
     */
    ...
    public function setStoreId($storeId)
    {
        if (!is_null($storeId) && (mb_strlen($storeId) > 20)) {
            throw new \InvalidArgumentException('invalid length for $storeId when calling SecondaryTransaction., must be smaller than or equal to 20.');
        }
    ...
    public function setMerchantTransactionId($merchantTransactionId)
    {
        if (!is_null($merchantTransactionId) && (mb_strlen($merchantTransactionId) > 40)) {
            throw new \InvalidArgumentException('invalid length for $merchantTransactionId when calling SecondaryTransaction., must be smaller than or equal to 40.');
        }
     ...
     * Sets comments
     *
     * @param string|null $comments Comment for the secondary transaction.
     *
     * @return $this
     */
