 ...
 * @link     https://openapi-generator.tech
 */
class FraudScore implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FraudScore';
     ...
     * Sets explanations
     *
     * @param object[]|null $explanations Explanation of the fraud score applied consisting of a description, type of the explanation, and rule (if applicable).
     *
     * @return $this
     */
     ...
     *
     * @param string|null $recommendedDecision The score attributed to this request by our machine learning system, ranging from 0 (less likely to be fraud) to 1000 (more likely to be fraud).
     *
     * @return $this
     */
