...
class Secure3D21AuthenticationRequest extends AuthenticationRequest 
{
    ...
    public function setRecurringExpiry($recurringExpiry)
    {
        ...
        if (!is_null($recurringExpiry) && (!preg_match("/^([0-9]{4})(1[0-2]|0[1-9])(3[01]|0[1-9]|[12][0-9])$/", $recurringExpiry))) {
            throw new \InvalidArgumentException("invalid value for $recurringExpiry when calling Secure3D21AuthenticationRequest., must conform to the pattern /^([0-9]{4})(1[0-2]|0[1-9])(3[01]|0[1-9]|[12][0-9])$/.");
        }
    ...
    public function setRecurringFrequency($recurringFrequency)
    {
        ...
        if (!is_null($recurringFrequency) && ($recurringFrequency > 9999)) {
            throw new \InvalidArgumentException('invalid value for $recurringFrequency when calling Secure3D21AuthenticationRequest., must be smaller than or equal to 9999.');
        }
        if (!is_null($recurringFrequency) && ($recurringFrequency < 1)) {
            throw new \InvalidArgumentException('invalid value for $recurringFrequency when calling Secure3D21AuthenticationRequest., must be bigger than or equal to 1.');
        }
