<?php
/**
 * GenerateCertificateFromCsrResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GenerateCertificateFromCsrResponse Class Doc Comment
 *
 * @category Class
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GenerateCertificateFromCsrResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GenerateCertificateFromCsrResponse';
     ...
     * Sets certificate
     *
     * @param string $certificate Certificate file (x509) encoded in Base64.
     *
     * @return $this
     */
