...
/**
 * DeleteBrandingStyleConfigurationResponse Class Doc Comment
 *
 * @category Class
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DeleteBrandingStyleConfigurationResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteBrandingStyleConfigurationResponse';
     ...
     * Sets status
     *
     * @param string|null $status Status from delete branding style configuration process.
     *
     * @return $this
     */
