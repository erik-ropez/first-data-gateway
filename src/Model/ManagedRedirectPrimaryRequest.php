...
/**
 * ManagedRedirectPrimaryRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ManagedRedirectPrimaryRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagedRedirectPrimaryRequest';
    ...
    public function setStoreId($storeId)
    {
        if (!is_null($storeId) && (mb_strlen($storeId) > 20)) {
            throw new \InvalidArgumentException('invalid length for $storeId when calling ManagedRedirectPrimaryRequest., must be smaller than or equal to 20.');
        }
    ...
    public function setMerchantTransactionId($merchantTransactionId)
    {
        if (!is_null($merchantTransactionId) && (mb_strlen($merchantTransactionId) > 40)) {
            throw new \InvalidArgumentException('invalid length for $merchantTransactionId when calling ManagedRedirectPrimaryRequest., must be smaller than or equal to 40.');
        }
     ...
     *
     * @return \FirstData\FirstApi\Client\Model\ManagedRedirectTransactionType|null
     */
     ...
     *
     * @param \FirstData\FirstApi\Client\Model\ManagedRedirectTransactionType|null $transactionType transactionType
     *
     * @return $this
     */
