...
/**
 * DynamicPricingExchangeRateRequestAllOf Class Doc Comment
 *
 * @category Class
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DynamicPricingExchangeRateRequestAllOf implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DynamicPricingExchangeRateRequest_allOf';
    ...
    public function setForeignCurrency($foreignCurrency)
    {
        if ((mb_strlen($foreignCurrency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $foreignCurrency when calling DynamicPricingExchangeRateRequestAllOf., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/([A-Z]{3})|([0-9]{3})/", $foreignCurrency))) {
            throw new \InvalidArgumentException("invalid value for $foreignCurrency when calling DynamicPricingExchangeRateRequestAllOf., must conform to the pattern /([A-Z]{3})|([0-9]{3})/.");
        }
