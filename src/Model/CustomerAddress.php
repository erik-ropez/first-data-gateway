...
class CustomerAddress implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(?!\\s*$).+/", $this->container['zipPostalCode'])) {
    ...
    public function setStreet($street)
    {
        ...
        if ((!preg_match("/^(?!\\s*$).+/", $street))) {
            throw new \InvalidArgumentException("invalid value for $street when calling CustomerAddress., must conform to the pattern /^(?!\\s*$).+/.");
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((!preg_match("/^(?!\\s*$).+/", $country))) {
            throw new \InvalidArgumentException("invalid value for $country when calling CustomerAddress., must conform to the pattern /^(?!\\s*$).+/.");
        }
    ...
    public function setZipPostalCode($zipPostalCode)
    {
        ...
        if ((!preg_match("/^(?!\\s*$).+/", $zipPostalCode))) {
            throw new \InvalidArgumentException("invalid value for $zipPostalCode when calling CustomerAddress., must conform to the pattern /^(?!\\s*$).+/.");
        }
