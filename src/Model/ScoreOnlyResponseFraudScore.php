...
/**
 * ScoreOnlyResponseFraudScore Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ScoreOnlyResponseFraudScore implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScoreOnlyResponse_fraudScore';
    ...
    protected static $openAPITypes = [
        'score' => 'string',
        'warnings' => 'string[]',
        'explanations' => '\FirstData\FirstApi\Client\Model\ScoreOnlyResponseFraudScoreExplanations[]',
     ...
     * Sets score
     *
     * @param string|null $score The score attributed to this request by our machine learning system, ranging from 0 (less likely to be fraud) to 1000 (more likely to be fraud).
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param string[]|null $warnings A list of non-critical warnings raised while processing the request. Warnings included in this list will have integration and data-quality related messages.
     *
     * @return $this
     */
     ...
     * Gets explanations
     *
     * @return \FirstData\FirstApi\Client\Model\ScoreOnlyResponseFraudScoreExplanations[]|null
     */
     ...
     * Sets explanations
     *
     * @param \FirstData\FirstApi\Client\Model\ScoreOnlyResponseFraudScoreExplanations[]|null $explanations Explanation of the fraud score applied consisting of a description, type of the explanation, and rule (if applicable).
     *
     * @return $this
     */
