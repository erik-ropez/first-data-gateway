...
/**
 * PaymentCardForcedTicketTransactionAllOf Class Doc Comment
 *
 * @category Class
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaymentCardForcedTicketTransactionAllOf implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentCardForcedTicketTransaction_allOf';
    ...
    public function setReferenceNumber($referenceNumber)
    {
        if ((mb_strlen($referenceNumber) > 8)) {
            throw new \InvalidArgumentException('invalid length for $referenceNumber when calling PaymentCardForcedTicketTransactionAllOf., must be smaller than or equal to 8.');
        }
        if ((!preg_match("/^(?!\\s*$).+/", $referenceNumber))) {
            throw new \InvalidArgumentException("invalid value for $referenceNumber when calling PaymentCardForcedTicketTransactionAllOf., must conform to the pattern /^(?!\\s*$).+/.");
        }
