...
/**
 * ManagedRedirectResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ManagedRedirectResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagedRedirectResponse';
     ...
     * Sets orderId
     *
     * @param string|null $orderId Note - Client Order ID if supplied by client which should not contain any special characters or spaces. If not supplied by client, IPG will generate. The first 12 alphanumeric digits are passed down to Fiserv Enterprise reporting tool, Clientline and Data File Manager (DFM).
     *
     * @return $this
     */
     ...
     * Sets redirectURL
     *
     * @param string|null $redirectURL URL for embedded payment link.
     *
     * @return $this
     */
