 ...
 * @link     https://openapi-generator.tech
 */
class Secure3DAuthenticationResult extends AuthenticationResult 
{
    ...
    public function setCavv($cavv)
    {
        if (!is_null($cavv) && (mb_strlen($cavv) > 32)) {
            throw new \InvalidArgumentException('invalid length for $cavv when calling Secure3DAuthenticationResult., must be smaller than or equal to 32.');
        }
        if (!is_null($cavv) && (mb_strlen($cavv) < 20)) {
            throw new \InvalidArgumentException('invalid length for $cavv when calling Secure3DAuthenticationResult., must be bigger than or equal to 20.');
        }
