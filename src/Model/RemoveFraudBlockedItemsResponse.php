...
/**
 * RemoveFraudBlockedItemsResponse Class Doc Comment
 *
 * @category Class
 * @description Response from remove fraud blocked items request.
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RemoveFraudBlockedItemsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RemoveFraudBlockedItemsResponse';
     ...
     * Sets status
     *
     * @param string|null $status Status from delete fraud blocked items operation.
     *
     * @return $this
     */
