...
/**
 * WalletPaymentMethod Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class WalletPaymentMethod implements ModelInterface, ArrayAccess
{
    const DISCRIMINATOR = 'walletType';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletPaymentMethod';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['walletType'] = static::$openAPIModelName;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['walletType'] === null) {
            $invalidProperties[] = "'walletType' can't be null";
        }
