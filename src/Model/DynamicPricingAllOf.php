...
/**
 * DynamicPricingAllOf Class Doc Comment
 *
 * @category Class
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DynamicPricingAllOf implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DynamicPricing_allOf';
    ...
    public function setForeignCurrency($foreignCurrency)
    {
        ...
        if ((!preg_match("/([A-Z]{3})|([0-9]{3})/", $foreignCurrency))) {
            throw new \InvalidArgumentException("invalid value for $foreignCurrency when calling DynamicPricingAllOf., must conform to the pattern /([A-Z]{3})|([0-9]{3})/.");
        }
    ...
    public function setForeignAmount($foreignAmount)
    {
        ...
        if ((!preg_match("/^(?!\\s*$).+/", $foreignAmount))) {
            throw new \InvalidArgumentException("invalid value for $foreignAmount when calling DynamicPricingAllOf., must conform to the pattern /^(?!\\s*$).+/.");
        }
