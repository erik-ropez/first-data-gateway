...
class TransactionResponse implements ModelInterface, ArrayAccess
{
    ...
    public function getTransactionStatusAllowableValues()
    {
        return [
            ...
            self::TRANSACTION_STATUS_PARTIAL,
    ...
    public function setPaymentAccountReferenceNumber($paymentAccountReferenceNumber)
    {
        if (!is_null($paymentAccountReferenceNumber) && (mb_strlen($paymentAccountReferenceNumber) > 30)) {
            throw new \InvalidArgumentException('invalid length for $paymentAccountReferenceNumber when calling TransactionResponse., must be smaller than or equal to 30.');
        }
