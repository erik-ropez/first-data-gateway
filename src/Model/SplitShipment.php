...
class SplitShipment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SplitShipment';
     ...
     * Sets totalCount
     *
     * @param int|null $totalCount Total count of the shipment, can be set at preauth or the first postauth.
     *
     * @return $this
     */
     ...
     * Sets finalShipment
     *
     * @param bool|null $finalShipment Indicates whether the transaction is the final shipment.
     *
     * @return $this
     */
