...
/**
 * MasterpassWalletPaymentMethodAllOf Class Doc Comment
 *
 * @category Class
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MasterpassWalletPaymentMethodAllOf implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MasterpassWalletPaymentMethod_allOf';
    ...
    public function setWalletId($walletId)
    {
        if ((mb_strlen($walletId) > 3)) {
            throw new \InvalidArgumentException('invalid length for $walletId when calling MasterpassWalletPaymentMethodAllOf., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^\\S$|^\\S.*\\S$/", $walletId))) {
            throw new \InvalidArgumentException("invalid value for $walletId when calling MasterpassWalletPaymentMethodAllOf., must conform to the pattern /^\\S$|^\\S.*\\S$/.");
        }
