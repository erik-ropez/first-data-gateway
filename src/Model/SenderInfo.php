...
class SenderInfo implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['accountNumber']) > 19)) {
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SenderInfo., must be smaller than or equal to 30.');
        }
    ...
    public function setStreetAddress($streetAddress)
    {
        if ((mb_strlen($streetAddress) > 50)) {
            throw new \InvalidArgumentException('invalid length for $streetAddress when calling SenderInfo., must be smaller than or equal to 50.');
        }
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 25)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SenderInfo., must be smaller than or equal to 25.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        if ((mb_strlen($postalCode) > 5)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling SenderInfo., must be smaller than or equal to 5.');
        }
    ...
    public function setReferenceNumber($referenceNumber)
    {
        if ((mb_strlen($referenceNumber) > 19)) {
            throw new \InvalidArgumentException('invalid length for $referenceNumber when calling SenderInfo., must be smaller than or equal to 19.');
        }
    ...
    {
        if ((mb_strlen($accountNumber) > 19)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling SenderInfo., must be smaller than or equal to 19.');
        }
