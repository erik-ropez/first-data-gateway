...
class PaymentFacilitator implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/[a-zA-Z0-9]{1,11}/", $this->container['paymentFacilitatorId'])) {
            $invalidProperties[] = "invalid value for 'paymentFacilitatorId', must be conform to the pattern /[a-zA-Z0-9]{1,11}/.";
        }
    ...
    public function setPaymentFacilitatorId($paymentFacilitatorId)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{1,11}/", $paymentFacilitatorId))) {
            throw new \InvalidArgumentException("invalid value for $paymentFacilitatorId when calling PaymentFacilitator., must conform to the pattern /[a-zA-Z0-9]{1,11}/.");
        }
