...
class PurchaseCardsLevel2 implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['customerReferenceID']) && (mb_strlen($this->container['customerReferenceID']) > 20)) {
            $invalidProperties[] = "invalid value for 'customerReferenceID', the character length must be smaller than or equal to 20.";
        }
     ...
     *
     * @param string|null $customerReferenceID Customer code/customer reference ID.
     *
     * @return $this
     */
    public function setCustomerReferenceID($customerReferenceID)
    {
        if (!is_null($customerReferenceID) && (mb_strlen($customerReferenceID) > 20)) {
            throw new \InvalidArgumentException('invalid length for $customerReferenceID when calling PurchaseCardsLevel2., must be smaller than or equal to 20.');
        }
