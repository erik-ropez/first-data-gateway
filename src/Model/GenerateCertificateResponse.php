 ...
 * @link     https://openapi-generator.tech
 */
class GenerateCertificateResponse implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['privateKeyPassword'] === null) {
            $invalidProperties[] = "'privateKeyPassword' can't be null";
        }
     ...
     * Sets zipFile
     *
     * @param string $zipFile Zip file containing new private key and signed certificate in PKCS#12 and JKS format, encoded in Base64.
     *
     * @return $this
     */
     ...
     *
     * @param string $privateKeyPassword Password for PKCS#12 / Private Key Password.
     *
     * @return $this
     */
