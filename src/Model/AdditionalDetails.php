...
class AdditionalDetails implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'mrchntRefData' => 'setMrchntRefData',
    ...
    protected static $getters = [
        ...
        'mrchntRefData' => 'getMrchntRefData',
    ...
    const SCA_EXEMPTION_TYPE_AUTHENTICATION_OUTAGE_EXCEPTION = 'Authentication Outage Exception';
    ...
    public function getScaExemptionTypeAllowableValues()
    {
        return [
            ...
            self::SCA_EXEMPTION_TYPE_AUTHENTICATION_OUTAGE_EXCEPTION,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['mrchntRefData'] = isset($data['mrchntRefData']) ? $data['mrchntRefData'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['mrchntRefData']) && (mb_strlen($this->container['mrchntRefData']) > 30)) {
            $invalidProperties[] = "invalid value for 'mrchntRefData', the character length must be smaller than or equal to 30.";
        }
     ...
     * @return string|null
     */
    public function getMrchntRefData()
    {
        return $this->container['mrchntRefData'];
    }

    /**
     * Sets mrchntRefData
     *
     * @param string|null $mrchntRefData Merchant Reference Data 2.
     *
     * @return $this
     */
    public function setMrchntRefData($mrchntRefData)
    {
        if (!is_null($mrchntRefData) && (mb_strlen($mrchntRefData) > 30)) {
            throw new \InvalidArgumentException('invalid length for $mrchntRefData when calling AdditionalDetails., must be smaller than or equal to 30.');
        }

        $this->container['mrchntRefData'] = $mrchntRefData;
