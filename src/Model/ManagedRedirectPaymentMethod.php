...
class ManagedRedirectPaymentMethod implements ModelInterface, ArrayAccess
{
    ...
    const PAYMENT_METHOD_TYPE_GIROPAY = 'GIROPAY';
    const PAYMENT_METHOD_TYPE_IDEAL = 'IDEAL';
    const PAYMENT_METHOD_TYPE_KLARNA = 'KLARNA';
    const PAYMENT_METHOD_TYPE_KPS = 'KPS';
    const PAYMENT_METHOD_TYPE_PAYPAL = 'PAYPAL';
    const PAYMENT_METHOD_TYPE_SBPS_OTHER_PAYMENTS = 'SBPS_OTHER_PAYMENTS';
    const PAYMENT_METHOD_TYPE_SOFORT = 'SOFORT';
    ...
    {
        return [
            self::PAYMENT_METHOD_TYPE_GIROPAY,
            self::PAYMENT_METHOD_TYPE_IDEAL,
            self::PAYMENT_METHOD_TYPE_KLARNA,
            self::PAYMENT_METHOD_TYPE_KPS,
            self::PAYMENT_METHOD_TYPE_PAYPAL,
            self::PAYMENT_METHOD_TYPE_SBPS_OTHER_PAYMENTS,
            self::PAYMENT_METHOD_TYPE_SOFORT,
        ];
    }
