 ...
 * @link     https://openapi-generator.tech
 */
class Sepa implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sepa';
    ...
    public function setIban($iban)
    {
        if ((mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling Sepa., must be smaller than or equal to 34.');
        }
        if ((!preg_match("/^(?!\\s*$).+/", $iban))) {
            throw new \InvalidArgumentException("invalid value for $iban when calling Sepa., must conform to the pattern /^(?!\\s*$).+/.");
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 96)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Sepa., must be smaller than or equal to 96.');
        }
        if ((!preg_match("/^(?!\\s*$).+/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling Sepa., must conform to the pattern /^(?!\\s*$).+/.");
        }
    ...
    public function setCountry($country)
    {
        if ((mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling Sepa., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^(?!\\s*$).+/", $country))) {
            throw new \InvalidArgumentException("invalid value for $country when calling Sepa., must conform to the pattern /^(?!\\s*$).+/.");
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Sepa., must be smaller than or equal to 254.');
        }
