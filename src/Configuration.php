...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://cert.api.firstdata.com/gateway/v2';
    ...
    {
        $report  = 'PHP SDK (FirstData\FirstApi\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 21.2.0.20210406.001' . PHP_EOL;
