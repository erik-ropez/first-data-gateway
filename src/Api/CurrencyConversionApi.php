...
/**
 * CurrencyConversionApi Class Doc Comment
 *
 * @category Class
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
...
class CurrencyConversionApi
{
     ...
     * @param  \FirstData\FirstApi\Client\Model\ExchangeRateRequest $exchangeRateRequest Accepted request types: DCCExchangeRateRequest and DynamicPricingExchangeRateRequest. (required)
     ...
     * @return \FirstData\FirstApi\Client\Model\ExchangeRateResponse|\FirstData\FirstApi\Client\Model\ErrorResponse|\FirstData\FirstApi\Client\Model\ErrorResponse|\FirstData\FirstApi\Client\Model\ErrorResponse|\FirstData\FirstApi\Client\Model\ErrorResponse|\FirstData\FirstApi\Client\Model\ErrorResponse|\FirstData\FirstApi\Client\Model\ErrorResponse
     */
    public function getExchangeRate($contentType, $clientRequestId, $apiKey, $timestamp, $exchangeRateRequest, $messageSignature = null, $region = null)
    {
        list($response) = $this->getExchangeRateWithHttpInfo($contentType, $clientRequestId, $apiKey, $timestamp, $exchangeRateRequest, $messageSignature, $region);
        return $response;
    }
     ...
     */
    public function getExchangeRateWithHttpInfo($contentType, $clientRequestId, $apiKey, $timestamp, $exchangeRateRequest, $messageSignature = null, $region = null)
    {
        $request = $this->getExchangeRateRequest($contentType, $clientRequestId, $apiKey, $timestamp, $exchangeRateRequest, $messageSignature, $region);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FirstData\FirstApi\Client\Model\ExchangeRateResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FirstData\FirstApi\Client\Model\ExchangeRateResponse', []),
            ...
            $returnType = '\FirstData\FirstApi\Client\Model\ExchangeRateResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FirstData\FirstApi\Client\Model\ExchangeRateResponse',
     ...
     */
    public function getExchangeRateAsync($contentType, $clientRequestId, $apiKey, $timestamp, $exchangeRateRequest, $messageSignature = null, $region = null)
    {
        return $this->getExchangeRateAsyncWithHttpInfo($contentType, $clientRequestId, $apiKey, $timestamp, $exchangeRateRequest, $messageSignature, $region)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExchangeRateAsyncWithHttpInfo($contentType, $clientRequestId, $apiKey, $timestamp, $exchangeRateRequest, $messageSignature = null, $region = null)
    {
        $returnType = '\FirstData\FirstApi\Client\Model\ExchangeRateResponse';
        $request = $this->getExchangeRateRequest($contentType, $clientRequestId, $apiKey, $timestamp, $exchangeRateRequest, $messageSignature, $region);
     ...
     */
    protected function getExchangeRateRequest($contentType, $clientRequestId, $apiKey, $timestamp, $exchangeRateRequest, $messageSignature = null, $region = null)
    {
        // verify the required parameter 'contentType' is set
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling getExchangeRate'
            );
        }
        // verify the required parameter 'clientRequestId' is set
        if ($clientRequestId === null || (is_array($clientRequestId) && count($clientRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $clientRequestId when calling getExchangeRate'
            );
        }
        // verify the required parameter 'apiKey' is set
        if ($apiKey === null || (is_array($apiKey) && count($apiKey) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiKey when calling getExchangeRate'
            );
        }
        // verify the required parameter 'timestamp' is set
        if ($timestamp === null || (is_array($timestamp) && count($timestamp) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $timestamp when calling getExchangeRate'
            );
        }
        // verify the required parameter 'exchangeRateRequest' is set
        if ($exchangeRateRequest === null || (is_array($exchangeRateRequest) && count($exchangeRateRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $exchangeRateRequest when calling getExchangeRate'
            );
        }

        $resourcePath = '/exchange-rates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($exchangeRateRequest)) {
            $_tempBody = $exchangeRateRequest;
        }
